...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('categories.create')->with('status', 'Category successfult created');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('categories.edit', [$id])->with('status', 'Category successfult updated');
    }
    ...
    // untuk menampilkan data yang soft delete
    function trash()
    {
    ...
    // untuk restore catergory yang sudah dihapus
    function restore($id)
    {
        ...
        return redirect()->route('categories.index')->with('status', 'Category successfult restored');
    }
